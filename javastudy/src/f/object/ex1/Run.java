...
public class Run {
	 ...
	 * 
	 * 2. 객체란 : 현실세계에서 독립적(목적이 있고 가치가 있는 것)으로 전재하는 모든 것을 의미
	 ...
	 * 
	 * ex) 학생 관리 프로그램
	 * 1) 학생관련 객체(최경채훈련생, 최용준훈련생, 안재휘훈련생 등등 ..) 
	 ...
	 * 			최경채라는 훌련생 객체 하나 만들기 -> String name1 = "최경채"; int age = 20; double height = 185.0;
	 * 			안재휘라는 훌련생 객체 하나 만들기 -> String name2 = "안재휘"; int age2 = 19; double height2 = 19.0;
	 * 
	 * 		2. 배열로 프로그래밍 한다면
	 ...
	 * 			외부로부터의 "데이터접근을 막고"
	 * 			대신에 "데이터를 간접적으로 처리(값을 변경하거나, 가져오는 것 등)"할 메소드들을 클래스 내부에 작성하여 관리하는 것
	 * 			다양한 기능을 묶어 하나의 큰 기능을 만들어주는 것
	 * 
	 */
